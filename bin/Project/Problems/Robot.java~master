...
public class Robot {
	...
	public static final OdometryCorrection odoCorrector = new OdometryCorrection(lightSensor); 
	...
	public static final double MyHome[][] = new double[1][1];
	public static final double OppHome[][] = new double[1][1];
	public static final double finaldest[][] = new double[1][1]; 
